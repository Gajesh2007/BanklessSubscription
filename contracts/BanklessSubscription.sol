...
contract BanklessSubscription is Ownable, ERC721URIStorage {
    ...
    function buyNFT(uint256 months) external returns (bool) {
        ...
        bank.transferFrom(msg.sender, address(this), 1000000000000000000000*months); // Transfer tokens from sender to contract, external fees WILL apply, so be careful with distribution.
